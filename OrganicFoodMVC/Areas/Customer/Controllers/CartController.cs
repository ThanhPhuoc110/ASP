    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
			...
			else
			{
				...
				if (ShoppingCartVM.OrderHeader.OrderTotal < 12000)
				{
					ModelState.AddModelError(string.Empty, "The minimum order amount must be at least ₫12,000.");
				...
				try
				{
					...
					{
						Amount = Convert.ToInt32(ShoppingCartVM.OrderHeader.OrderTotal), // Ensure this is in đồng
						Currency = "vnd",
